    ...
    <main className="flex flex-col gap-10 w-full ">
      ...
      <section className="flex flex-col items-center gap-30 lg:gap-0 xl:gap-0">
        <div className="flex flex-col items-center gap-13 px-11 md:flex-row md:items-start md:gap-0 md:px-12 lg:px-30 xl:pl-36 xl:pr-50 xl:gap-13">
          <Image src="/portfolio/portrait.png" width="400" height="600" fill={false} alt="animated portrait" className="md:pr-11 lg:pr-15 xl:pr-5"></Image>
        ...
        <Tabs
          tabs={[
            { id: "1", name: "Work", contents:  [
                                                    {id:"1", image: "/portfolio/work/fiu-nursing.jpg", link:"https://cnhs.fiu.edu/", date:"Aug 2024 - Now", name: "Nicole Wertheim College of Nursing and Health Sciences", position: "Student It Lab Assistant", desc: [{content:"Delivered technical support to 200+ students and staff. resolved hardware and software issues with a 95% first-contact resolution rate and maintaining 99% system uptime for seamless daily operations."},{content:"Managed IT inventory, including 100+ devices, ensuring accurate tracking and timely updates, resulting in a 20% reduction in equipment loss."}]},
                                                    {id:"2", image: "/portfolio/work/go-fans-ai.png", link:"https://gofans.ai/", date:"Dec 2024 - Jun 2025", name: "GoFans.Ai", position: "Data scientist (Intern)", desc: [{content:"Interpreted Team Ideas for a Music Emotion Recognition Model, leveraged Python, Keras, Essentia, AWS Lambda, SageMaker, and S3 Buckets to build a Data Pipeline and Machine learning model."}, {content:"Achieved an average API runtime of 5 seconds, a model accuracy of 80%, and gathering interest of 100% of app investors."}]},
                                                    {id:"3", image: "/portfolio/work/cahsi.png", link:"https://cahsi.utep.edu/", date:"Feb 2024 - Jun 2024", name: "Computing Alliance of Hispanic-Serving Institutions", position: "Undergraduate research assistant", desc: [{content:"Evaluated and researched Security vulnerabilities and Defense Mechanisms in Generative Language AI models and delivered a visual presentation captivating 100% of Evaluators."}]},
                                                    
                                                ] },
            { id: "2", name: "Education", contents: [
                                                      {id:"1", image:"/portfolio/work/fiu-panther.jpg", link:"https://www.fiu.edu/", date:"Jan 2025 - Now", name: "Florida International University", position: "MS in Computer Science", desc: []},
                                                      {id:"2", image:"/portfolio/work/fiu-panther.jpg", link:"https://www.fiu.edu/", date:"Jun 2020 - Dec 2024", name: "Florida International University", position: "BS in Computer Science", desc: [{content:"2-time recipient of the Deans List Award"},{content: "Datascience & AI Technical Lead for the FIU CodeCrunch Student Organization"}]}
                                                    ]}
          ]}
        />
      </section>
